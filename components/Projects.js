            ...
            <div className="mt-20 ">
                ...
                <div className="pb-8 mb-2 border-t-2 border-gray-300 dark:border-white-300"></div>
                  ...
                  <div className="mt-8 p-2  m-2 mb-6   ">
                    ...
                    <h1 className="text-2xl font-bold pb-2  hover:underline flex items-center gap-2">BLOG APP
                   <BsArrowUpRight fontSize={25}  />
                    </h1>
                ...
                <div className="mt-8 p-2 m-2 mb-6  ">
                    ...
                    <h1 className="text-2xl font-bold pb-2  hover:underline flex items-center gap-2">SEARCHIFY
                    <BsArrowUpRight  fontSize={25}/>
                    </h1>
